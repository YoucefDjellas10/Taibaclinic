...
class QuotationsTreatment(models.Model):
    _name = 'quotations.treatment'
    _description = 'quotations Treatment for patients'

    name = fields.Char(string='ID', readonly=True)
    quotation = fields.Many2one('quotations', string='Quotation')
